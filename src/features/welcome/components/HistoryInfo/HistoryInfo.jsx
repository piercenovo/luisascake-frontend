import { Container, Image, ImgContainer, InfoContainer, Parr, Title, Welcome, Wrapper } from './HistoryInfoStyles'
  ...
  return (
    <Container>
      <Wrapper>
        ...
        <ImgContainer>
          <Image src='https://res.cloudinary.com/cloud-digital-asset/image/upload/v1665611826/LuisasCake/about-1_rzdogx.png' alt='Historia' />
        </ImgContainer>
      </Wrapper >
    </Container>
  )
